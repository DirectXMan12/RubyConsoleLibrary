...
h2. note: not yet ruby 1.9 compatible (it is more than just changing the constant names from X to RUBY_X - the ascii color support seems to be broken, at lease on Windows 7, and I also get some errors in getch)
